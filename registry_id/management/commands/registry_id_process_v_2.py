...
class Command(BaseCommand):
    help = 'Команда для парсинга реестра неддеспособных граждан'
    ...
    def __process_parsing(self, *args, **options):
        ...
        try:
            ...
            print(f"Начинаем обработку файла {registry_settings.file_for_processing}")
            with open(TEMP_FILE_EXTRACTION_DIR / extract_file_name, mode='r') as csv_file:
                ...
                for line in tqdm(tuple(csv_file)):
                    ...
                    try:
                        ...
                        current_error = f'Ошибка добавления в DTO {self.CURRENT_DTO.__name__}:\nline: {line}\n' \
