...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        REGISTRY_CHOICE_MARK = RegistryNameChoices.REGISTRY_ZP
        ...
        with open(os.path.join(EXTRACTION_DIR, extract_file_name), mode='r') as csv_file:
            ...
            for line in tqdm(tuple(csv_file)):
                ...
                try:
                    ...
                    current_error = f'Ошибка добавления в DTO: {CURRENT_DTO.__name__}. split_line: {split_line}. ' \
                                    f'ReesrtStrDTO: {row_dto.get_data}'
